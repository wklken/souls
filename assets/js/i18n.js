...
(function() {
  ...
  const translations = {
    zh: {
      ...
      'stats.interesting': '{count} 位有趣灵魂',
      'nav.home': '首页',
      'nav.real_world': '真实世界',
      'nav.virtual_world': '非真实世界',
      'nav.personas': '专家角色',
      'nav.interesting': '有趣灵魂',
      'nav.browse': '浏览分类',
      'action.copy': '复制内容',
      ...
      'soul.openclaw_guide_title': 'OpenClaw 使用指引',
      'soul.openclaw_guide_intro': '只要 3 步。',
      'soul.openclaw_step_run': '输入命令：',
      'soul.openclaw_step_clear_prefix': '切换后执行',
      'soul.openclaw_step_clear_suffix': '（或直接新开会话）。',
      'soul.openclaw_link_skill': '查看 find-souls',
      'soul.openclaw_link_docs': '查看 ClawHub 文档',
    ...
    en: {
      ...
      'stats.interesting': '{count} interesting souls',
      'nav.home': 'Home',
      'nav.real_world': 'Real World',
      'nav.virtual_world': 'Virtual World',
      'nav.personas': 'Personas',
      'nav.interesting': 'Interesting Souls',
      ...
      'soul.openclaw_guide_title': 'OpenClaw guide',
      'soul.openclaw_guide_intro': 'Only 3 steps.',
      'soul.openclaw_step_run': 'Run command:',
      'soul.openclaw_step_clear_prefix': 'After switching, run',
      'soul.openclaw_step_clear_suffix': '(or just open a new session).',
      'soul.openclaw_link_skill': 'View find-souls',
      'soul.openclaw_link_docs': 'View ClawHub docs',
      'footer.copyright': '© 2026 Souls Project',
