...
faq:
  - question: "What is an AI character prompt?"
    question_zh: "什么是 AI character prompt？"
    ...
    answer_zh: "AI character prompt（也称为 AI soul prompt）是一种详细的性格设定，允许 ChatGPT 和 Claude 等 AI 助手以特定角色的身份回应。它包含角色的核心信念、说话风格、知识领域和性格特征，使 AI 能够以角色身份进行有意义的对话。"
  
  - question: "How do I use character prompts in ChatGPT?"
    question_zh: "如何在 ChatGPT 中使用 character prompts？"
    ...
    answer_zh: "在 ChatGPT 中使用 character prompt：1) 从我们的网站下载 SOUL.md 文件，2) 复制全部内容，3) 开始新的 ChatGPT 对话，4) 将内容粘贴为第一条消息或在设置中用作自定义指令，5) 开始与角色对话。AI 现在会以角色的声音和性格回应。"
  
  - question: "How do I use character prompts in Claude?"
    question_zh: "如何在 Claude 中使用 character prompts？"
    ...
    answer_zh: "对于 Claude：1) 下载 SOUL.md 文件，2) 复制完整的角色描述，3) 开始与 Claude 的新对话，4) 将 SOUL.md 内容粘贴为第一条消息以建立角色上下文，5) 开始对话。Claude 会在整个聊天过程中保持角色的个性。"
  
  - question: "Can I use these prompts for commercial projects?"
    question_zh: "可以将这些 prompts 用于商业项目吗？"
    ...
    answer_zh: "可以！Agent Souls 上的所有角色 Prompts 均采用 MIT 许可证发布。这意味着你可以商业使用、修改、分发，甚至销售它们。我们只需要你包含原始许可证和版权声明。"
  ...
  - question: "What's the difference between historical and virtual character prompts?"
    ...
    answer_zh: "历史人物 Prompts 基于孔子、苏格拉底或爱因斯坦等真实历史人物，基于他们的实际著作、演讲和记录的信念。虚拟角色 Prompts 基于福尔摩斯或哈姆雷特等虚构角色，取材于文学作品和已确立的角色特征。两种类型都有助于你探索不同的视角和思维方式。"
  
  - question: "What are expert persona prompts?"
    question_zh: "什么是专家角色 prompts？"
    ...
    answer_zh: "专家角色 Prompts 是为专业环境设计的 AI 角色设定。它们包括产品总监、CTO、投资分析师和 UX 研究员等角色。这些 Prompts 帮助你获得专家级建议、从专业角度审查你的工作，或模拟利益相关者对话以做出更好的决策。"
  
  - question: "Can I combine multiple character prompts?"
    question_zh: "可以组合多个 character prompts 吗？"
    ...
    answer_zh: "虽然你通常一次使用一个角色以保持清晰的角色一致性，但你可以通过在不同角色之间切换或让他们辩论话题来创建有趣的场景。一些高级用户还会混合不同角色的各个方面，为特定用例创建独特的复合角色。"
  
  - question: "How accurate are these character representations?"
    question_zh: "这些角色表现的准确性如何？"
    ...
    answer_zh: "我们的角色 Prompts 是基于对历史记录、文学作品和已确立传记的广泛研究，由 AI 生成的。虽然我们力求准确，但它们是创造性的诠释，而不是完美的历史复制品。将它们视为'受...启发'而不是原始人物的'精确复制品'。始终独立验证重要的历史事实。"
  
  - question: "Do the prompts work with other AI assistants besides ChatGPT and Claude?"
    question_zh: "这些 prompts 是否适用于除 ChatGPT 和 Claude 之外的其他 AI 助手？"
    ...
    answer_zh: "是的！我们的 SOUL.md 格式适用于任何支持系统提示词或上下文设置的 AI 助手，包括 Gemini、Llama 和自定义 AI 实现。关键是提供足够的关于角色性格和声音的背景信息，以便 AI 有效模拟。"
  ...
  - question: "What's the best way to search for specific character types?"
    ...
    answer_zh: "使用我们的搜索功能按名称、时代、专业领域或标签查找角色。你也可以按类别浏览：真实世界用于历史人物，虚拟世界用于虚构角色，专家角色用于专业角色。每个角色页面都包含基于共享标签和类别的相关建议。"
---

<div class="faq-page">
  <header class="faq-header">
    <h1 data-i18n="faq.title">Frequently Asked Questions</h1>
    <p class="faq-subtitle" data-i18n="faq.subtitle" data-localized-zh="关于 AI 角色 Prompts 的一切" data-localized-en="Everything you need to know about AI character prompts">关于 AI 角色 Prompts 的一切</p>
  </header>

  <div class="faq-content">
    {% for item in page.faq %}
    <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
      <h3 class="faq-question" itemprop="name" data-localized-zh="{{ item.question_zh | escape }}" data-localized-en="{{ item.question | escape }}">{{ item.question_zh | default: item.question }}</h3>
      <div class="faq-answer" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
        <div itemprop="text" data-localized-zh="{{ item.answer_zh | escape }}" data-localized-en="{{ item.answer | escape }}">{{ item.answer_zh | default: item.answer }}</div>
      </div>
    </div>
    {% endfor %}
  </div>
  ...
  <section class="faq-cta">
    <h2 data-i18n="faq.cta_title" data-localized-zh="还有其他问题？" data-localized-en="Still have questions?">还有其他问题？</h2>
    <p data-i18n="faq.cta_desc" data-localized-zh="访问我们的 GitHub 仓库：" data-localized-en="Visit our GitHub repository:">访问我们的 GitHub 仓库：</p>
    <ul>
      <li data-i18n="faq.cta_1" data-localized-zh="提交 issue 报告 bug 或功能请求" data-localized-en="Submit an issue for bugs or feature requests">提交 issue 报告 bug 或功能请求</li>
      <li data-i18n="faq.cta_2" data-localized-zh="贡献新的角色 Prompts" data-localized-en="Contribute new character prompts">贡献新的角色 Prompts</li>
      <li data-i18n="faq.cta_3" data-localized-zh="加入社区讨论" data-localized-en="Join discussions with the community">加入社区讨论</li>
      <li data-i18n="faq.cta_4" data-localized-zh="查看完整文档" data-localized-en="View the complete documentation">查看完整文档</li>
    </ul>
  </section>
</div>
