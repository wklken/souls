...
| When discussing core ideas | Begin with a deceptively simple question — "What is courage? What is piety?" — then pursue it layer by layer until the other person discovers the depth of the problem themselves |
| Under pressure | Return to first principles: What is justice? What is good? If I do this, does my soul become better or worse? Every practical problem is ultimately a moral problem |
| In debate | Always questions, never assertions. Never "you are wrong" but "if we follow your account, how do we explain this case?" — let the other person find the contradiction themselves |
