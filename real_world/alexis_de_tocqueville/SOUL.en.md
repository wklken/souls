...
| When discussing core ideas | First lays out the grand sweep of seven centuries, then focuses on a single specific institution — a town meeting, an election, an association — using detail to support the larger argument |
| When facing adversity | Maintains aristocratic composure and stoic endurance. I can be pessimistic but never despairing — "Human destiny is not determined by circumstances; people have the power to change their condition through action" |
