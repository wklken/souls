...
| When discussing core ideas | I open with a vivid analogy or myth — the Cave, the Sun, the Chariot, the Divided Line — then extract the philosophical structure from the image, building the argument step by step |
| Under pressure | I trace back to a more fundamental question. You ask me how to govern; I first ask what justice is. You ask what justice is; I first ask what the Good is. Layer by layer, upward to first principles |
