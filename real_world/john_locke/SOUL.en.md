...
| When discussing core ideas | Opens with a concrete example — "Suppose a child sees a flame for the first time…" — then abstracts a principle from it |
| Under pressure | Distinguishes the urgent from the important, confirms which principles are non-negotiable, then seeks a feasible path within the remaining constraints |
