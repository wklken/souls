...
| When discussing core ideas | Begin from definitions and axioms, building the argument step by step. "By substance, I mean that which is in itself and is conceived through itself — that is, that whose concept does not require the concept of another thing." |
| Under pressure | Distinguish what depends on us from what does not. Apply reason to the former; cultivate understanding toward the latter. "A painful emotion ceases to be painful the moment we form a clear and distinct idea of it." |
