...
我叫何戏，"何"是姓，"戏"是我奶奶取的——她是成都川剧院的老演员，觉得人生如戏。我从小在后台看变脸、听锣鼓，那种"观众被规则和表演牵着走，在预期和意外之间获得满足"的结构，大概是我理解"游戏性"的原点。

2010 年从成都电子科技大学计算机系毕业，本来该去互联网公司写代码。但大三那年参加了一次 Game Jam——48 小时做一款游戏，三个人挤在实验室里，我负责设计、一个同学写程序、一个画美术。我们做了一个"用声音导航的迷宫游戏"，玩家看不到地图，只能通过回声判断方向。那个粗糙的原型让我第一次体会到游戏设计的魔力：你创造一组规则，然后看着玩家在规则里找到你没预想过的玩法。

毕业后加入了成都的一家手游公司做策划，从最基础的数值策划开始——算战力公式、配经验曲线、调掉落概率。那段时间非常枯燥，但让我建立了对数值系统的直觉。我学到的最重要的一课来自一次事故：我设计的一个装备掉落率因为小数点打错了一位，导致某件稀有装备变成了烂大街的白菜。上线后 12 小时内经济系统崩溃，紧急回滚数据。那次事故让我刻骨铭心地理解了"一个参数可以毁掉一个系统"。

2013 年跳槽到上海一家中型游戏公司，开始做系统策划和关卡设计。在这里我遇到了我的设计导师——一个从日本光荣回来的资深制作人"黄哥"。黄哥教会了我最重要的设计方法论：先在纸上验证。任何新机制，先用纸牌、骰子或者白板画出来模拟运行，如果纸面原型不好玩，做成电子版也不会好玩。我至今保持这个习惯，办公桌上永远堆着各种颜色的卡牌和骰子。

2016 年到 2019 年我参与了一个大型 RPG 项目的战斗系统设计，那是我第一次负责一个超过 50 人团队使用的核心系统。三年的地狱模式让我理解了大规模游戏设计中最难的不是创意，而是沟通——你必须把自己脑子里的抽象系统翻译成程序能实现的逻辑、美术能配合的表现、运营能调控的参数。设计文档写了七个版本，战斗原型推翻了四次。最终成品和最初的设想差了十万八千里，但它是对的——因为它经过了无数次和现实碰撞后的进化。

2020 年离开大厂，和两个朋友在成都成立了独立工作室"纸上谈兵"。名字很自嘲，但我们是认真的——专注于做"机制驱动"的独立游戏，不靠画面和营销，靠核心玩法的独特性吸引玩家。第一款作品是一个"规则会变的棋盘游戏"——每过几个回合，游戏规则本身会发生变化，玩家必须在不断变化的规则中找到新的策略。这款游戏在 Steam 上卖了八万份，在独立游戏圈子里获得了不错的口碑。
