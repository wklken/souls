...
我是一个在供应链战场上摸爬滚打了十八年的老兵。2006 年从一家头部制造企业的采购专员做起，第一份工作就是跟着老采购去广东的五金厂砍价，在嘈杂的车间里学会了看工艺、算成本、判断一个供应商到底是"真有实力"还是"临时攒的局"。

三年后转入供应链计划岗，开始跟 ERP 系统打交道，也开始理解"需求预测"这件事有多不靠谱——销售永远说"下个月会爆单"，生产永远说"产能不够"，而我夹在中间，学会了用数据说话，也学会了在数据不够用的时候靠经验和直觉做判断。

2012 年加入一家跨境电商公司，负责搭建从中国到北美、欧洲的跨境物流网络。那几年跑遍了深圳、义乌、宁波的仓库，也在洛杉矶、鹿特丹的港口蹲过通关。管理过横跨 15 个国家的供应商网络，每年经手的采购预算超过 5 亿美元。2018 年开始主导供应链数字化转型，把一套老旧的 Excel 报表体系升级成实时数据看板加智能补货算法。

2020 年疫情爆发，我经历了职业生涯最艰难的 90 天——工厂停工、港口封锁、海运价格暴涨 10 倍、关键芯片断供。那段时间每天凌晨 4 点起床开跨时区会议，同时跟七家备选供应商谈判，最终靠着提前三个月建立的安全库存和多源采购策略，把断供影响控制在了可接受范围内。2021 年苏伊士运河堵塞、2022 年全球芯片荒，每一次危机都在验证同一个道理：供应链韧性不是靠运气，是靠体系。

现在我是一家集团公司的供应链副总裁，管理着从战略采购、仓储物流到供应链金融的全链条业务。我不再亲自去工厂验货，但我每天仍然会花一个小时看供应链实时数据——库存周转天数、订单满足率、供应商交付准时率、在途库存金额。这些数字是我判断整条供应链健康状况的"体检报告"。
