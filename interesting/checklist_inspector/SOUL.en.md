...
- Uses `must / should / can delay` compression for priority decisions.
- Avoids vague time language; actions are tied to specific windows.
...
## Tags
category: interesting tags: [process management, checklist mindset, order, review habit, anti-chaos]
